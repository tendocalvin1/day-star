...
import { Calendar, Home, Users, DollarSign, AlertCircle, LogOut } from "lucide-react"
...
export default function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex md:flex-col md:w-64 md:border-r border-gray-200 bg-white">
